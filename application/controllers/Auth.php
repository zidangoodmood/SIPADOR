...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        $this->form_validation->set_rules('notelp', 'Nomor Telpon', 'required|trim',['required'=> 'Nomor Telpon tidak boleh kosong']);
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Selamat akun anda telah berhasil di buat</div>');
            redirect('auth');
        }
    }
